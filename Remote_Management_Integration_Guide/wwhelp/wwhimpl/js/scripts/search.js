...
function  WWHSearch_InitBodyHTML()
{
  ...
  if ( ! this.mbBookSearchInfoLoaded)
  {
    ...
    //
    HTML.fAppend("<p class=\"psearch\">" + WWHFrame.WWHJavaScript.mMessages.mInitializingMessage + "</p>\n");
  ...
  else  // Perform search
  {
    ...
    //
    HTML.fAppend("<h4>" + WWHFrame.WWHJavaScript.mMessages.mSearchSearchingMessage + "</h4>\n");
...
function  WWHSearch_StartHTMLSegments()
{
  ...
  if (this.mbPanelInitialized)
  {
    ...
    {
      HTML.fAppend("<p>" + WWHFrame.WWHJavaScript.mMessages.mSearchDefaultMessage + "</p>\n");
    }
    ...
    {
      HTML.fAppend("<h4>" + WWHFrame.WWHJavaScript.mMessages.mSearchNothingFoundMessage + "</h4>\n");
    }
  }
...
function FixSearchWordsText(ParamText)
{
  //remove selected special characters , defined below in reg , can be replaced by space or nothing , " " or ""
  //
  var reg = /\$|,|@|#|\%|\*|\&|\(|\)|\[|\]|\[|\}|\{|\:|\'|\"|\<|\>|\?|\||\\|\$|\./g;  //less rigorous
  //var reg = /\$|,|@|#|~|`|\%|\*|\^|\&|\(|\)|\+|\=|\[|\-|\_|\]|\[|\}|\{|\;|\:|\'|\"|\<|\>|\?|\||\\|\!|\$|\./g;   //more rigorous

  ParamText = ParamText.replace(reg, " ").replace(/\s+/g, " ");   
...
function  WWHSearch_Submit()
{
  ...
  // Update search words
  //
  NewSearchWords = FixSearchWordsText(SearchForm.elements["WWHSearchWordsText"].value);
